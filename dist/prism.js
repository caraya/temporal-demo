/* PrismJS 1.29.0
https://prismjs.com/download.html?#themes=prism-solarizedlight&languages=markup+css+clike+javascript+c+csharp+coffeescript+css-extras+dart+django+docker+glsl+go+graphql+handlebars+haskell+http+java+js-extras+json+json5+latex+lua+makefile+markdown+markup-templating+nginx+objectivec+php+php-extras+processing+python+r+jsx+rest+ruby+sass+scss+scala+scheme+soy+tcl+toml+typescript+wiki+xquery+yaml&plugins=line-highlight+keep-markup+toolbar+copy-to-clipboard+treeview */
